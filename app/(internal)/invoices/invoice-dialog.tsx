          ...
          <div>
            ...
            {!attachedDoc ? (
              ...
              <div className="mt-1.5 rounded-lg border border-[var(--border)] bg-[var(--panel-2)] p-2.5">
                ...
                {/* Campos ocultos para registrar el archivo ya almacenado por el escáner */}
                {attachedDoc.source === "scanner" && attachedDoc.storagePath ? (
                  <>
                    <input type="hidden" name="scanner_storage_path" value={attachedDoc.storagePath} />
                    <input type="hidden" name="scanner_file_name" value={attachedDoc.fileName} />
                    <input type="hidden" name="scanner_file_size" value={attachedDoc.fileSizeBytes || ""} />
                  </>
                ) : null}
