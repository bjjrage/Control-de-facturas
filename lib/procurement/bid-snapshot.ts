...
export async function getTenderAnalysisSnapshots(
  ...
  try {
    ...
    const runs: BidAnalysisRunRecord[] = (data ?? []).map((r: any) => ({
      ...
      precioOfertaRecomendadoPyg: r.precio_oferta_recomendado_pyg != null ? Number(r.precio_oferta_recomendado_pyg) : null,
      margenNetoEstimadoPct: r.margen_neto_estimado_pct != null ? Number(r.margen_neto_estimado_pct) : null,
      probabilidadGanarPct: r.probabilidad_ganar_pct != null ? Number(r.probabilidad_ganar_pct) : null,
