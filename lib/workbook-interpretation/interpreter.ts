...
- columnMappings: rol de cada columna útil. En certificados: quantity = cantidad contractual, previousQuantity/currentQuantity/cumulativeQuantity, unitPrice, previousAmount/currentAmount/cumulativeAmount, percentage. En presupuestos: code, description, unit, quantity, unitPrice, subtotal. En EXECUTION (registro de avance físico por rubro, tipo "libro de obra"): code, description, unit, currentQuantity = cantidad ejecutada en ESTE período (a escala de contrato, no por unidad individual); si hay columnas de detalle por vivienda/unidad, no las mapees, alcanza con la columna agregada del período.
