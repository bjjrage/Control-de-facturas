      ...
      for (const tc of toolCalls) {
        ...
        try {
          const idempotencyKey =
            toolInput && typeof toolInput === "object" && typeof (toolInput as { idempotency_key?: unknown }).idempotency_key === "string"
              ? (toolInput as { idempotency_key: string }).idempotency_key
              : null;
