...
async function runTests() {
  ...
  const mockInput: BidEngineInput = {
    ...
    complianceReport: { tenderId: 'TENDER-PARAGUAY-2026', isEligibleToBid: true, scoreCumplimientoPct: 100, totalRequirements: 4, cumplidosCount: 4, generablesCount: 0, faltantesCount: 0, evaluations: [] },
    ...
    financialReport: { tenderId: 'TENDER-PARAGUAY-2026', offerAmountPyg: 11000000000, totalCostPyg: 9000000000, baseScenario: { scenarioName: 'BASE', paymentLagDays: 140, peakWorkingCapitalRequiredPyg: 2000000000, financingCostPyg: 280000000, grossProfitPyg: 2000000000, netProfitPyg: 1720000000, grossMarginPct: 18.18, netMarginPct: 15.64, isFinanciallyViable: true, notes: '' }, conservativeScenario: {} as any, stressScenario: {} as any, recommendedFinancingBufferPyg: 2000000000, overallViability: 'VIABLE' },
    simulationResult: { tenderId: 'TENDER-PARAGUAY-2026', referenceBudgetPyg: 12000000000, simulatedCompetitorsCount: 5, winningPriceDistribution: { p10WinningPricePyg: 10500000000, p50WinningPricePyg: 11000000000, p90WinningPricePyg: 11400000000 }, winProbabilityCurve: [], recommendedSweetSpotDiscountPct: 8.3, recommendedSweetSpotPricePyg: 11000000000, iterationsRun: 10000 }
  };
