...
async function runTests() {
  ...
  const mockInput: BidEngineInput = {
    ...
    complianceReport: { tenderId: 'TENDER-PARAGUAY-2026', isEligibleToBid: true, evidenceOrigin: 'EXTRACTED_FROM_PBC', scoreCumplimientoPct: 100, totalRequirements: 4, cumplidosCount: 4, generablesCount: 0, faltantesCount: 0, evaluations: [] },
